// ============================================================
// Norfolk County, MA Camp Finder — Camp Data & Configuration
// Summer 2026 — Greater Norfolk County, MA
// AUTO-GENERATED by search-agent — review before use
// ============================================================
...
const NEIGHBORHOOD_AREAS = [
  {
    area: "Central (Norwood & Neighbors)",
    neighborhoods: [
  ...
  {
    area: "North (Needham / Wellesley / Brookline)",
    neighborhoods: [
  ...
  {
    area: "South (Sharon / Stoughton / Foxborough)",
    neighborhoods: [
  ...
  {
    area: "Southwest (Franklin / MetroWest)",
    neighborhoods: [
...
const CAMPS = [
  ...
  // ===================================================
  {
    ...
    tags: ["soccer", "field-sports", "youth", "all-levels", "summer-camp"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["soccer", "summer camp", "Nike Sports Camps", "all skill levels", "Metro South", "youth soccer"],
    neighborhood: "dedham",
  ...
  },
  {
    ...
    tags: ["gymnastics", "summer camp", "swimming", "sports", "day camp", "Norwood"],
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["multi-sport", "youth", "soccer", "football", "basketball", "baseball"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    tags: ["cheerleading", "tumbling", "all-star", "youth sports", "Norwood"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["ninja", "parkour", "obstacle-course", "fitness", "athletics", "multi-sport"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    tags: ["ice skating", "learn-to-skate", "all ages", "multiple locations", "competitive progression", "hockey"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["baseball", "sports", "youth", "fundamentals", "coaching", "day-camp"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["sports", "play-based", "flexible-hours", "multi-activity", "outdoor-games", "summer-camp"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["soccer", "summer camp", "youth sports", "skill development", "team training", "multi-week sessions"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["soccer", "skills-based", "youth", "summer camp", "field-sports"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["tennis", "court-sports", "all-levels", "summer-camp", "instruction"],
    neighborhood: "walpole",
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Check website"],
    weeks: ["w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["hockey", "ice-sports", "skills-training", "summer-camp", "massachusetts"],
    neighborhood: "canton",
    description: "Check website",
    sentiment: "",
    ageRange: "5-12",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "individual-combat",
    tags: ["horse-riding", "hunter-seat", "equestrian", "day-camp", "ages-6-16", "english-riding"],
    neighborhood: "stoughton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["baseball", "softball", "sports", "lessons", "indoor"],
    neighborhood: "stoughton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "individual-combat",
    tags: ["rock climbing", "youth programs", "summer camp", "indoor climbing", "skill development", "ages 3.5-18"],
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "individual-combat",
    tags: ["gymnastics", "tumbling", "physical-fitness", "skill-building", "youth-sports", "flexibility"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["basketball", "court-sports", "summer camps", "youth athletics", "skill development", "indoor sports"],
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["basketball", "day camp", "skill development", "youth sports", "team play", "fundamentals"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["soccer", "multi-sport", "youth", "indoor", "skills-based", "rolling-admission"],
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Online Waiver"],
    weeks: ["w01", "w03", "w04", "w05", "w07", "w09"]
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["gymnastics", "ninja", "obstacle course", "motor skills", "athletic development", "themed weeks"],
    neighborhood: "norwood",
    ...
    registrationDeadline: "Check website",
    documents: ["Check website"],
    weeks: ["w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "sports",
    subcategory: "individual-combat",
    tags: ["horseback riding", "equestrian", "horsemanship", "barn management", "summer camp"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "individual-combat",
    tags: ["gymnastics", "summer camp", "arts and crafts", "water play", "team building", "daily gymnastics"],
    ...
    registrationDeadline: "Check website",
    documents: ["Current Physical Exam", "Up-To-Date Immunization Records", "Pick-Up Authorization Form", "Medication Administration Release Form", "Sunscreen Authorization Form", "Camp Consent Form"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09"]
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["summer recreation", "multi-sport", "field trips", "swimming", "arts and crafts"],
    neighborhood: "plainville",
  ...
  },
  {
    ...
    tags: ["hockey", "ice-sports", "skill-development", "summer-camp", "multi-activity", "youth"],
    neighborhood: "norwood",
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Check website"],
    weeks: ["w01", "w03", "w04", "w05", "w06", "w07", "w08", "w09"]
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["multi-sport", "basketball", "baseball", "soccer", "summer camp", "outdoor"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["multi-sport", "baseball", "basketball", "soccer", "lacrosse", "tennis"],
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Health form", "Waiver", "Asthma Authorization Form", "Epipen Authorization Form", "Authorization to Give Medicine Form"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10", "w11"]
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["multi-sport", "enrichment", "athletics", "summer camp", "Brookline MA", "ages 3.5-18"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["day camp", "sports", "swimming", "youth", "community"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["ninja", "parkour", "fitness", "obstacle course", "multi-sport", "summer camp"],
    neighborhood: "norwood",
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Check website"],
    weeks: ["w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10", "w11"]
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["multi-sport", "aquatics", "dance", "climbing", "tumbling", "family-friendly"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["hockey", "skating", "ice-sports", "summer-camp", "youth-programs", "Boston-Bruins"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "water-sports",
    tags: ["swimming", "competitive", "technique", "advanced", "summer camp", "youth"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["basketball", "youth sports", "court-sports", "summer camp", "skill development", "teamwork"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    ageRange: "5-13",
    cost: "Check website",
    location: "Fenway-Kenmore-Longwood-Mission Hill",
    url: "https://ymcaboston.org/youth-and-family/camps/",
    registrationDeadline: "Check website",
    documents: ["Check website"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["soccer", "summer camp", "skill development", "indoor facility", "youth sports"],
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["cricket", "indoor sports", "youth training", "elite coaching", "skill development", "facility-based"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["baseball", "softball", "athletic training", "skill development", "leadership", "conditioning"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["hockey", "ice-hockey", "skills-training", "elite-coaching", "summer-camp", "massachusetts"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["pool", "waterpark", "unlimited access", "social events", "themed activities", "multi-sport", "water-sports", "day-camp"],
    neighborhood: "dedham",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["preschool", "early development", "structured activities", "playful exploration", "social growth", "multi-sport", "water-sports", "day-camp"],
    neighborhood: "dedham",
    description: "The Summer Club at Dedham Health & Athletic Complex offers three dynamic camp experiences: The Summer Club with unlimited pool access and social events, My First Camp (ages 4-6) with structured activities and playful exploration, and The Ultimate Day Camp (ages 7-14) featuring swimming, arts and crafts, sports, ropes courses, and themed days. Junior Tennis Academy Summer Camp (ages 6-16) provides personalized tennis instruction combined with swim breaks and off-court fun.",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["full-day camp", "swimming", "arts and crafts", "sports", "ropes courses", "themed days", "lunch included", "extended hours"],
    neighborhood: "dedham",
    description: "The Summer Club at Dedham Health & Athletic Complex offers three dynamic camp experiences: The Summer Club with unlimited pool access and social events, My First Camp (ages 4-6) with structured activities and playful exploration, and The Ultimate Day Camp (ages 7-14) featuring swimming, arts and crafts, sports, ropes courses, and themed days. Junior Tennis Academy Summer Camp (ages 6-16) provides personalized tennis instruction combined with swim breaks and off-court fun.",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["tennis", "skill-building", "fundamentals", "match strategy", "competitive games", "swim breaks", "multi-sport", "water-sports"],
    neighborhood: "dedham",
    description: "The Summer Club at Dedham Health & Athletic Complex offers three dynamic camp experiences: The Summer Club with unlimited pool access and social events, My First Camp (ages 4-6) with structured activities and playful exploration, and The Ultimate Day Camp (ages 7-14) featuring swimming, arts and crafts, sports, ropes courses, and themed days. Junior Tennis Academy Summer Camp (ages 6-16) provides personalized tennis instruction combined with swim breaks and off-court fun.",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["baseball", "elite coaches", "hitting", "fielding", "base running"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["basketball", "skill development", "fundamental development", "shooting", "team play"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["softball", "elite coaches", "hitting", "fielding", "action-packed"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["soccer", "training", "match game instruction", "goal-setting"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["softball", "elite coaches", "hitting", "fielding", "Assumption University"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["football", "contact football", "fundamental skills", "position-specific coaching"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["softball", "elite coaches", "hitting", "fielding", "daily drills"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "field-sports",
    tags: ["lacrosse", "boys lacrosse", "Boston", "Blue Hills Reservation"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "individual-combat",
    tags: ["golf", "all components of game", "skill improvement", "coaching"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["volleyball", "individual skills", "position-specific", "team skills", "all skill levels"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "court-sports",
    tags: ["basketball", "volleyball", "pickleball", "open gym", "day-camp", "multi-sport", "swimming", "arts"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["gymnastics", "swimming", "arts and crafts", "preschool", "summer camp", "sports", "day camp", "Norwood"],
    neighborhood: "norwood",
    description: "Gymnastic Academy of Boston offers two summer camp options: Preschool Summer Camp for 4-year-olds featuring gymnastics instruction, swimming in their in-ground pool, arts and crafts, and theme weeks; and The Ultimate Grade School Summer Day Camp for ages 5+ combining rigorous gymnastic training with swimming, team building activities, obstacle courses, and open gym time in a fully air-conditioned facility.",
    sentiment: "The teachers at G.A.B. always have control of the class, keep the children engaged, and have them showing steady improvements.",
    ageRange: "5-14",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["gymnastics", "swimming", "obstacle courses", "team building", "grade school", "summer camp", "sports", "day camp"],
    neighborhood: "norwood",
    description: "Gymnastic Academy of Boston offers two summer camp options: Preschool Summer Camp for 4-year-olds featuring gymnastics instruction, swimming in their in-ground pool, arts and crafts, and theme weeks; and The Ultimate Grade School Summer Day Camp for ages 5+ combining rigorous gymnastic training with swimming, team building activities, obstacle courses, and open gym time in a fully air-conditioned facility.",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "water-sports",
    tags: ["swimming", "preschool", "kindergarten", "activities", "friendships", "water-sports", "enrichment", "South Easton"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "water-sports",
    tags: ["swimming", "multi-activity", "friendships", "water-sports", "archery", "dance", "preschool", "kindergarten"],
    neighborhood: "norwood",
    description: "Maplewood's Preschool & Kindergarten Camp (ages 3-5) offers engaging activities that spark curiosity through swimming instruction, outdoor exploration, and creative play. With over 30,000 children having learned to swim since 1965, the camp emphasizes individual instruction and positive reinforcement in two heated pools. Children enjoy varied activities throughout the day including sports, dance, archery, and water activities in a warm, welcoming environment.",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "water-sports",
    tags: ["counselor-in-training", "teen", "leadership", "swimming", "preschool", "kindergarten", "water-sports", "enrichment"],
    neighborhood: "norwood",
    description: "Maplewood's Preschool & Kindergarten Camp (ages 3-5) offers engaging activities that spark curiosity through swimming instruction, outdoor exploration, and creative play. With over 30,000 children having learned to swim since 1965, the camp emphasizes individual instruction and positive reinforcement in two heated pools. Children enjoy varied activities throughout the day including sports, dance, archery, and water activities in a warm, welcoming environment.",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["summer camp", "multiple sports", "theme days", "tournament day", "multi-sport", "brookline", "sports clinics", "youth sports"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["soccer", "summer camp", "multi-sport", "brookline", "sports clinics", "youth sports", "team sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["baseball", "summer camp", "multi-sport", "brookline", "sports clinics", "youth sports", "team sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["flag football", "summer camp", "multi-sport", "brookline", "sports clinics", "youth sports", "team sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["basketball", "summer camp", "multi-sport", "brookline", "sports clinics", "youth sports", "team sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["soccer", "academy", "advanced training", "multi-sport", "summer camp", "brookline", "sports clinics", "youth sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["pre-K", "half-day", "multi-sport", "summer camp", "brookline", "sports clinics", "youth sports", "team sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "5-14",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["preschool", "half-day", "multi-sport", "summer camp", "brookline", "sports clinics", "youth sports", "team sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "5-14",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["school vacation", "multi-sport", "indoor", "summer camp", "brookline", "sports clinics", "youth sports", "team sports"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "sports",
    subcategory: "multi-sport",
    tags: ["ninja warrior", "obstacles", "agility", "strength", "balance", "multi-sport", "summer camp", "brookline"],
    neighborhood: "brookline",
    description: "Viking's Multi-Sports Summer Camp offers a fun-filled experience with Theme Days and their famous Tournament Day. Campers participate in various sports including soccer, baseball, flag football, and basketball across multiple field and gymnasium locations in Brookline, with access to the entire Cypress Field complex and indoor facilities.",
    sentiment: "",
    ageRange: "3-18",
  ...
  // ===================================================
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["dance", "summer camp", "themed weeks", "multiple styles", "Norwood MA", "youth"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["theater", "summer camp", "performing arts", "dance", "musical theater", "ensemble"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["theater", "drama", "performance", "youth", "creative", "confidence-building"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual-arts", "painting", "ceramics", "creative-expression", "summer-camp", "hands-on"],
    neighborhood: "walpole",
    ...
    registrationDeadline: "Check website",
    documents: ["Check website"],
    weeks: ["w03", "w04", "w05", "w06", "w07", "w08", "w09"]
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual-arts", "painting", "drawing", "illustration", "teen-week", "plein-air"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["nature", "art", "pottery", "painting", "wildlife", "outdoor"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["preschool", "arts", "nature-study", "outdoor-play", "music", "creative-movement"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["art", "visual-arts", "summer-camp", "creative", "canton-ma", "youth"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["dance", "summer camp", "youth dance", "movement", "skill development"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["summer camp", "enrichment", "creative learning", "multi-age program", "discovery-based", "themed weeks"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["theater", "performing arts", "acting", "dance", "singing", "youth"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["musical theater", "teen program", "performance", "confidence-building", "professional production"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["dance", "ballet", "hip-hop", "Irish step", "summer camps", "multi-style"],
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["non-competitive", "dance education", "nurturing", "all-ages", "inclusive", "well-being"],
    neighborhood: "norfolk",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["musical theatre", "Broadway", "summer intensive", "performance", "ages 8-17", "showcase"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["theater", "drama", "performance", "arts", "youth", "summer-camp"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["outdoor-learning", "nature-exploration", "reggio-inspired", "preschool", "sensory-play", "themed-weeks"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["ballet", "dance", "summer camp", "ages 2-9", "Boston", "classical ballet"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["sewing", "arts", "crafts", "fiber-arts", "day-camp", "multiple-locations"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual arts", "painting", "drawing", "creative", "kids", "teens"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual-arts", "workshops", "painting", "printmaking", "ceramics", "art-classes"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["music", "performance-based learning", "rock music", "band experience", "all ages", "live performances"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual-arts", "painting", "sculpture", "art-history", "creative-expression", "museum-trips"],
    neighborhood: "brookline",
    ...
    registrationDeadline: "Check website",
    documents: ["Check website"],
    weeks: ["w01", "w03", "w05", "w06", "w07", "w09", "w10"]
  },
  {
    id: "artbarn-artbarn",
    name: "ArtBarn",
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["theater", "musical", "performance", "acting", "dance", "grades-2-8"],
    neighborhood: "brookline",
    ...
    documents: ["Tuition Assistance Application"],
    weeks: ["w03", "w04", "w05", "w06", "w07", "w08"]
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["ballet", "dance", "summer camp", "ages 2-9", "classical ballet", "creative movement"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["arts", "visual-arts", "performing-arts", "sports", "ages-7-15", "Brookline"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["pottery", "visual arts", "summer camp", "kids", "creative", "Brookline"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["puppetry", "theater", "arts", "summer camp", "vacation week", "hands-on"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["theater", "musical-theater", "singing", "acting", "teen-camp", "intensive"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "music",
    tags: ["music", "instruments", "summer camp", "young children", "music education", "brookline"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "music",
    tags: ["jazz", "music", "ensemble", "youth", "summer", "intensive"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    registrationDeadline: "Check website",
    documents: ["Check website"],
    weeks: ["w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10", "w11"]
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["dance", "arts", "youth-dance", "community-dance", "multiple-locations", "performing-arts"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual-arts", "museum-based", "art-classes", "weekend-programs", "summer-camp", "school-vacation"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["theater", "professional", "family-friendly", "boston", "arts", "education"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["music", "dance", "theater", "intensive", "summer", "performing-arts"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["dance", "acrobatics", "summer camp", "multi-activity", "themed camps", "family discount"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "music",
    tags: ["music", "arts", "stem", "summer-camp", "franklin-ma", "youth-programs"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual-arts", "summer-camp", "movie-making", "creative-expression", "youth-art"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["dance", "recital", "performance", "Franklin MA", "youth dance", "community"],
    neighborhood: "franklin",
    ...
    documents: ["Check website"],
    weeks: ["w01", "w02", "w03", "w05", "w06", "w07", "w08"]
  },
  {
    ...
    category: "arts",
    subcategory: "dance",
    tags: ["dance", "acrobatics", "cheer", "tumbling", "summer camps", "recreational"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "theater",
    tags: ["day camp", "theater", "arts", "Weymouth residents only"],
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["Montessori", "educational", "multi-activity", "themes", "art", "science", "music", "technology"],
    neighborhood: "norwood",
    ...
    documents: ["Summer Camp Application", "Check website"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual arts", "dance", "theater", "music", "video", "film", "photography", "creative writing"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["art", "science", "cooking", "leadership", "outdoor adventures", "sports", "day camp", "ACA-accredited"],
    neighborhood: "brookline",
    description: "Creative Arts at Park (CAAP) is an unforgettable arts experience for campers ages 7-15 where children grow, find friendships, and have fun creating their own schedules from offerings in visual arts, dance, theater, music, video/film, computers, photography, creative writing, martial arts, and sports. Under the guidance of professional artists and educators, campers discover talents and develop skills that provide life-long enjoyment.",
    sentiment: "",
    ageRange: "4-15",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["art", "creative expression", "small groups", "experienced instructors"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["visual arts", "performing arts", "sports", "professional instruction", "arts", "visual-arts", "performing-arts", "ages-7-15"],
    neighborhood: "brookline",
    description: "Creative Arts at Park provides children ages 7-15 with opportunities to explore visual and performing arts and sports under the guidance of professional artists. The performance-oriented program emphasizes an integral approach to the arts and creates a spirit of cooperation, helping students discover talents and develop skills for lifelong enjoyment.",
  ...
  },
  {
    ...
    category: "arts",
    subcategory: "visual-arts",
    tags: ["specialty-based", "electives", "arts", "sports", "STEAM", "flexible", "day camp", "multi-activity"],
  ...
  // ===================================================
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["coding", "game-design", "robotics", "video-editing", "animation", "cybersecurity"],
  ...
  },
  {
    ...
    tags: ["robotics", "STEM", "coding", "engineering", "hands-on-learning", "summer-camp"],
    neighborhood: "walpole",
    ...
    registrationDeadline: "Check website",
    documents: ["Check website"],
    weeks: ["w01", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    tags: ["tutoring", "enrichment", "personalized learning", "academic support", "pre-K through 12"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["LEGO", "robotics", "coding", "STEM", "stop-motion animation", "Minecraft"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["coding", "game-design", "robotics", "3D-printing", "STEM", "video-creation"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "engineering",
    tags: ["STEM", "invention", "hands-on learning", "problem-solving", "creativity", "engineering"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["coding", "robotics", "STEM", "summer camp", "Brookline MA", "hands-on learning"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["STEAM", "sports", "SEL", "enrichment", "summer camps", "after-school"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["STEM", "coding", "robotics", "tech camps", "game design", "video production"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["vocational", "trades", "plumbing", "cosmetology", "coding", "middle-school"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["STEM", "coding", "free", "summer", "hands-on learning", "creative"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["technology", "STEM", "coding", "summer 2026"],
    neighborhood: "milton",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["LEGO", "robotics", "motorized builds", "STEM", "coding", "animation", "engineering"],
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["LEGO", "coding", "stop motion", "animation", "robotics", "STEM", "engineering"],
    neighborhood: "westwood",
    description: "Students explore STEM through motorized LEGO builds, coding, and stop-motion animation. Young campers (ages 4-5) construct cartoon-inspired creations with motors and gears, while older students (ages 6-13) engage in video game-themed challenges, program EV3 robots, and produce professional stop-motion films.",
    sentiment: "",
    ageRange: "6-8",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["LEGO", "robotics", "MINDSTORMS", "Minecraft", "stop motion", "coding", "STEM", "animation"],
    neighborhood: "westwood",
    description: "Students explore STEM through motorized LEGO builds, coding, and stop-motion animation. Young campers (ages 4-5) construct cartoon-inspired creations with motors and gears, while older students (ages 6-13) engage in video game-themed challenges, program EV3 robots, and produce professional stop-motion films.",
    sentiment: "",
    ageRange: "9-13",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["robotics", "LEGO", "programming", "engineering", "hands-on learning", "coding", "STEM", "STEAM"],
    neighborhood: "westwood",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["coding", "technology", "video game design", "stop motion", "programming", "robotics", "STEM", "STEAM"],
    neighborhood: "westwood",
    description: "Snapology offers weekly STEM/STEAM summer camps using LEGO® bricks, K'Nex, and technology where kids build robots, create stop-motion movies, design video games, and explore coding and robotics. Children engage in hands-on projects across robotics, technology & coding, STEAM/STEM, and themed science camps, developing problem-solving skills and creativity through playful learning.",
    sentiment: "",
    ageRange: "5-12",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["science", "themed activities", "character-based learning", "creative play", "robotics", "coding", "STEM", "STEAM"],
    neighborhood: "westwood",
    description: "Snapology offers weekly STEM/STEAM summer camps using LEGO® bricks, K'Nex, and technology where kids build robots, create stop-motion movies, design video games, and explore coding and robotics. Children engage in hands-on projects across robotics, technology & coding, STEAM/STEM, and themed science camps, developing problem-solving skills and creativity through playful learning.",
    sentiment: "",
    ageRange: "5-12",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "coding",
    tags: ["workshops", "STEAM", "hands-on learning", "holiday programs", "teacher workshop days", "robotics", "coding", "STEM"],
    neighborhood: "westwood",
    description: "Snapology offers weekly STEM/STEAM summer camps using LEGO® bricks, K'Nex, and technology where kids build robots, create stop-motion movies, design video games, and explore coding and robotics. Children engage in hands-on projects across robotics, technology & coding, STEAM/STEM, and themed science camps, developing problem-solving skills and creativity through playful learning.",
    sentiment: "",
    ageRange: "5-12",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "engineering",
    tags: ["robotics", "STEM", "programming", "Lego", "building", "summer camp"],
    neighborhood: "walpole",
  ...
  },
  {
    ...
    category: "stem",
    subcategory: "engineering",
    tags: ["robotics", "STEM", "programming", "Lego", "building", "classes", "summer camp"],
    neighborhood: "walpole",
    description: "At WRA Summer Camps, kids ages 8-12 unleash their creativity and learn new STEM skills by building amazing robots with Lego that bring their imagination to life. The program provides immersive, focused curriculum to help children develop skills in building and programming robots.",
    sentiment: "",
    ageRange: "6-12",
  ...
  },
  {
    ...
    tags: ["nature exploration", "hands-on learning", "STEM activities", "outdoor education", "local trails", "habitats", "pollinators", "aquatic life"],
  ...
  // ===================================================
  {
    ...
    tags: ["swim-focused", "multi-sport", "arts-and-drama", "nature-immersion", "all-ages", "professional-staff"],
    neighborhood: "norwood",
    ...
    registrationDeadline: "Check website",
    documents: ["Camper Application Form"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["farm", "nature", "cooking", "outdoor", "animals", "ages 6-14"],
    neighborhood: "dover",
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Annual physical and immunization forms", "Emergency and pick up contact info", "Camper insurance policy and doctor contact"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["day camp", "outdoor learning", "multi-activity", "swimming", "adventure", "nature"],
    neighborhood: "westwood",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["day camp", "multi-sport", "arts and crafts", "water games", "family activities", "parish-based"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature-study", "outdoor-exploration", "multi-age", "wildlife", "hands-on-learning", "sanctuary-based"],
    neighborhood: "sharon",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["day camp", "multi-activity", "ages 4-15", "Sharon MA", "waterfront", "adventure"],
    neighborhood: "sharon",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["summer camp", "field trips", "grades K-8", "flexible schedule", "arts and recreation", "outdoor activities"],
    neighborhood: "stoughton",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["multi-sport", "indoor-play", "field-trips", "arts", "swimming", "ages-5-14"],
    neighborhood: "stoughton",
  ...
  },
  {
    ...
    tags: ["ropes-course", "swimming", "archery", "sports", "arts-crafts", "outdoor-adventure"],
    neighborhood: "stoughton",
    ...
    registrationDeadline: "Check website",
    documents: ["Family Handbook", "Safety Plan"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["multi-sport", "arts", "nature", "swimming", "team-building", "day-camp"],
    neighborhood: "stoughton",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["summer camp", "day camp", "grades 1-6", "outdoor adventure", "arts and crafts", "multi-activity"],
    neighborhood: "randolph",
  ...
  },
  {
    ...
    tags: ["ninja", "obstacle course", "fitness", "summer camp", "ages 5+", "skill-building"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["summer camp", "playground", "recreation", "K-8", "full-day", "half-day option"],
    neighborhood: "wrentham",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature", "outdoor education", "wildlife", "day camp", "nature exploration"],
    neighborhood: "norfolk",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["climbing", "indoor-sports", "youth-programs", "skill-building", "adventure", "fitness"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["farm", "nature-study", "gardening", "outdoor-learning", "ages-4-12", "boston"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["inclusive", "neuro-affirming", "outdoor-nature", "arts-based", "special-needs", "adaptive"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["scuba", "water-sports", "certification", "kids", "diving", "open-water"],
    neighborhood: "brookline",
    ...
    registrationDeadline: "Check website",
    documents: ["Diver Medical Statement Participant Questionnaire"],
    weeks: ["w01"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["multi-sport", "adventure", "arts", "summer camp", "flexible weeks", "age groups"],
    neighborhood: "franklin",
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Waiver", "Medication Waiver"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["summer camp", "Franklin MA", "recreation", "youth programs"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["day camp", "multi-activity", "outdoor", "arts", "adventure", "water activities"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["farm", "kids-programs", "nature", "agriculture", "outdoor", "educational"],
    neighborhood: "franklin",
    description: "Check website",
    sentiment: "",
    ageRange: "3-9",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "high-adrenaline",
    tags: ["ninja", "obstacle-course", "summer-camp", "games", "fitness", "weekday-program"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["farm", "agriculture", "nature-study", "hands-on", "seasonal", "family-friendly"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["summer-camp", "water-play", "arts-crafts", "sports", "recreation", "preschool-friendly"],
    neighborhood: "bellingham",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "outdoor-survival",
    tags: ["day camp", "adventure", "outdoor"],
    neighborhood: "weymouth",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["day camp", "swimming", "sports", "arts", "nature exploration", "team-building", "day-camp", "multi-activity"],
    neighborhood: "stoughton",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["gymnastics", "day camp", "summer camp", "day-camp", "multi-activity", "swimming", "arts", "sports"],
    neighborhood: "stoughton",
    description: "Camp West Woods offers a day camp experience on 10 beautiful acres in Stoughton where children participate in eight 40-minute activity periods daily. Campers enjoy daily swim instruction, free swim, lunch, and rotating activities including sports, creative arts, nature exploration, and team-building games. The camp creates a fun, engaging environment where children grow their skills, boost self-esteem, and build respect for others.",
    sentiment: "Trusted by Parents for Over 50 Years",
    ageRange: "4-14",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["science", "day camp", "summer camp", "day-camp", "multi-activity", "swimming", "arts", "sports"],
    neighborhood: "stoughton",
    description: "Camp West Woods offers a day camp experience on 10 beautiful acres in Stoughton where children participate in eight 40-minute activity periods daily. Campers enjoy daily swim instruction, free swim, lunch, and rotating activities including sports, creative arts, nature exploration, and team-building games. The camp creates a fun, engaging environment where children grow their skills, boost self-esteem, and build respect for others.",
    sentiment: "Trusted by Parents for Over 50 Years",
    ageRange: "4-14",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["traditional day camp", "waterfront", "outdoor adventure", "sports", "arts", "music", "drama", "Jewish culture"],
    neighborhood: "dover",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["swimming", "STEM", "creative exploration", "leadership", "character building", "day-camp", "field-trips", "multi-sport"],
    neighborhood: "needham",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["field trips", "hiking", "kayaking", "beach", "nature exploration", "day-camp", "swimming", "STEM"],
    neighborhood: "needham",
    description: "Charles River YMCA Day Camp blends fun with purpose through exciting group games, swimming, STEM activities, and creative exploration, helping campers build independence, leadership, and confidence. The Voyagers program (ages 7-13) features weekly field trips including Physical Challenge Week with hiking and kayaking, Fun & Games Week with go-kart racing and arcade adventures, and Beach Week at Massachusetts coastal spots.",
    sentiment: "Our campers don't just have fun—they grow into their best selves.",
    ageRange: "7-13",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["traditional day camp", "outdoor activity", "character building", "friendship", "day camp", "traditional camp", "ages 5-15", "outdoor activities"],
    neighborhood: "quincy",
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Physical exam form", "Health form", "Multiple registration forms"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["child care", "enrichment", "physical activity", "play-based learning", "early-childhood", "multi-sport", "playcentered", "daycare"],
    neighborhood: "weymouth",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["traditional activities", "summer camp", "early-childhood", "multi-sport", "enrichment", "playcentered", "daycare", "Weymouth"],
    neighborhood: "weymouth",
    description: "Energy Center Camp for ages 4-6 offers two hours of daily child care and enrichment activities guided by learning through play philosophy. Kids enjoy physical activity, fun programs, and age-appropriate Xcitement activities at the Weymouth Club's specially designed Energy Center facility.",
    sentiment: "",
    ageRange: "6-13",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["dance", "summer camp", "performing arts", "early-childhood", "multi-sport", "enrichment", "playcentered", "daycare"],
    neighborhood: "weymouth",
    description: "Energy Center Camp for ages 4-6 offers two hours of daily child care and enrichment activities guided by learning through play philosophy. Kids enjoy physical activity, fun programs, and age-appropriate Xcitement activities at the Weymouth Club's specially designed Energy Center facility.",
    sentiment: "",
    ageRange: "6-13",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["musical theater", "summer camp", "performing arts", "early-childhood", "multi-sport", "enrichment", "playcentered", "daycare"],
    neighborhood: "weymouth",
    description: "Energy Center Camp for ages 4-6 offers two hours of daily child care and enrichment activities guided by learning through play philosophy. Kids enjoy physical activity, fun programs, and age-appropriate Xcitement activities at the Weymouth Club's specially designed Energy Center facility.",
    sentiment: "",
    ageRange: "6-13",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["tennis", "academy", "instruction", "early-childhood", "multi-sport", "enrichment", "playcentered", "daycare"],
    neighborhood: "weymouth",
    description: "Energy Center Camp for ages 4-6 offers two hours of daily child care and enrichment activities guided by learning through play philosophy. Kids enjoy physical activity, fun programs, and age-appropriate Xcitement activities at the Weymouth Club's specially designed Energy Center facility.",
    sentiment: "",
    ageRange: "11-18",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "outdoor-survival",
    tags: ["ecology", "outdoor skills", "nature hike", "camping", "conservation", "environmental justice", "nature-study", "outdoor-skills"],
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["multi-sport", "swimming", "arts and crafts", "outdoor recreation", "team building", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["multi-sport", "swimming", "arts and crafts", "half-day program", "arts", "adventure", "water activities", "themed camps"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "4-6",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["immersive", "themed", "lightsaber training", "costume", "multi-sport", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "9-13",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["immersive", "themed", "quest", "costume", "multi-sport", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "9-12",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["immersive", "themed", "Hogwarts", "costume", "multi-sport", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "9-13",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["immersive", "themed", "competition", "challenges", "multi-sport", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "12-15",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["water-sports", "sailing", "treasure hunt", "adventure", "multi-sport", "arts", "water activities", "themed camps"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "7-12",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["visual arts", "expanded art program", "multiple mediums", "multi-sport", "arts", "adventure", "water activities", "themed camps"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "5-12",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["cooking", "indoor and outdoor cooking", "cooking competitions", "multi-sport", "arts", "adventure", "water activities", "themed camps"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "10-15",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["themed", "teamwork", "challenges", "competition", "multi-sport", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "10-13",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["multi-sport", "flag football", "soccer", "basketball", "skill-building", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "5-9",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["leadership development", "communication", "youth development", "teamwork", "multi-sport", "arts", "adventure", "water activities"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "13-16",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["triathlon training", "swimming", "running", "biking", "free program", "multi-sport", "arts", "adventure"],
    neighborhood: "norwood",
    description: "YMCA Camp Westwood offers traditional day camp, immersive themed camps (Star Wars, Percy Jackson, Harry Potter, Survivor), and specialty camps (Pirate Adventure, Art Explosion, Culinary, Sports Medley) across 80 acres of woodlands and a 300-acre reservoir. Campers ages 4-16 participate in over 70 activities including swimming, sports, arts and crafts, high ropes courses, and themed weekly programs with challenge-by-choice opportunities.",
    sentiment: "",
    ageRange: "5-16",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["multi-activity", "small group", "swimming", "archery", "outdoor play", "arts and crafts", "day camp", "ages 3-8"],
    neighborhood: "dedham",
    ...
    registrationDeadline: "Check website",
    documents: ["Health form", "Check website"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature exploration", "outdoor learning", "hands-on", "weekly themes", "nature-study", "outdoor-exploration", "hands-on learning", "ages 3-7"],
    neighborhood: "needham",
    ...
    registrationDeadline: "Rolling admission",
    documents: ["Health form", "Consent form", "Waiver of liability"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature exploration", "urban nature", "outdoor learning", "hands-on", "nature-study", "outdoor-exploration", "hands-on learning", "weekly themes"],
    neighborhood: "needham",
    description: "PUDDLESTOMPERS Summer Camp offers hands-on nature exploration for young naturalists aged 3 years 9 months to 7 years old. Following weekly themes, children investigate different nature topics through hands-on exploration, active outdoor play, crafts, stories, and songs guided by experienced teacher naturalists. Programs run 4.5 hours daily (9:00 am-1:30 pm) with optional early drop-off and extended day options available.",
    sentiment: "",
    ageRange: "3-7",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature exploration", "animal behavior", "outdoor learning", "hands-on", "nature-study", "outdoor-exploration", "hands-on learning", "weekly themes"],
    neighborhood: "needham",
    description: "PUDDLESTOMPERS Summer Camp offers hands-on nature exploration for young naturalists aged 3 years 9 months to 7 years old. Following weekly themes, children investigate different nature topics through hands-on exploration, active outdoor play, crafts, stories, and songs guided by experienced teacher naturalists. Programs run 4.5 hours daily (9:00 am-1:30 pm) with optional early drop-off and extended day options available.",
    sentiment: "",
    ageRange: "3-7",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature exploration", "metamorphosis", "camouflage", "outdoor learning", "nature-study", "outdoor-exploration", "hands-on learning", "weekly themes"],
    neighborhood: "needham",
    description: "PUDDLESTOMPERS Summer Camp offers hands-on nature exploration for young naturalists aged 3 years 9 months to 7 years old. Following weekly themes, children investigate different nature topics through hands-on exploration, active outdoor play, crafts, stories, and songs guided by experienced teacher naturalists. Programs run 4.5 hours daily (9:00 am-1:30 pm) with optional early drop-off and extended day options available.",
    sentiment: "",
    ageRange: "3-7",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature exploration", "reptiles", "amphibians", "outdoor learning", "nature-study", "outdoor-exploration", "hands-on learning", "weekly themes"],
    neighborhood: "needham",
    description: "PUDDLESTOMPERS Summer Camp offers hands-on nature exploration for young naturalists aged 3 years 9 months to 7 years old. Following weekly themes, children investigate different nature topics through hands-on exploration, active outdoor play, crafts, stories, and songs guided by experienced teacher naturalists. Programs run 4.5 hours daily (9:00 am-1:30 pm) with optional early drop-off and extended day options available.",
    sentiment: "",
    ageRange: "3-7",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature exploration", "predators", "animal behavior", "outdoor learning", "nature-study", "outdoor-exploration", "hands-on learning", "weekly themes"],
    neighborhood: "needham",
    description: "PUDDLESTOMPERS Summer Camp offers hands-on nature exploration for young naturalists aged 3 years 9 months to 7 years old. Following weekly themes, children investigate different nature topics through hands-on exploration, active outdoor play, crafts, stories, and songs guided by experienced teacher naturalists. Programs run 4.5 hours daily (9:00 am-1:30 pm) with optional early drop-off and extended day options available.",
    sentiment: "",
    ageRange: "3-7",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["nature exploration", "soil science", "animal habitats", "outdoor learning", "nature-study", "outdoor-exploration", "hands-on learning", "weekly themes"],
    neighborhood: "needham",
    description: "PUDDLESTOMPERS Summer Camp offers hands-on nature exploration for young naturalists aged 3 years 9 months to 7 years old. Following weekly themes, children investigate different nature topics through hands-on exploration, active outdoor play, crafts, stories, and songs guided by experienced teacher naturalists. Programs run 4.5 hours daily (9:00 am-1:30 pm) with optional early drop-off and extended day options available.",
    sentiment: "",
    ageRange: "3-7",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["outdoor adventure", "arts and crafts", "nature exploration", "swimming", "themed activities", "summer camp", "day camp", "grades 1-6"],
    neighborhood: "quincy",
    description: "Stars Summer Programs and Day Camp offer children entering grades 1-6 days filled with outdoor adventure, creativity, and hands-on learning. Campers participate in athletics, arts and crafts, nature exploration, swimming, and weekly themed experiences that spark imagination and curiosity. With opportunities to stay active, try new things, and build confidence, every day offers something exciting to discover.",
    sentiment: "",
    ageRange: "6-12",
  ...
  },
  {
    ...
    category: "adventure",
    subcategory: "nature-study",
    tags: ["outdoor adventure", "arts and crafts", "nature exploration", "swimming", "summer camp", "day camp", "grades 1-6", "multi-activity"],
    neighborhood: "westwood",
    description: "Stars Summer Programs and Day Camp offer children entering grades 1-6 days filled with outdoor adventure, creativity, and hands-on learning. Campers participate in athletics, arts and crafts, nature exploration, swimming, and weekly themed experiences that spark imagination and curiosity. With opportunities to stay active, try new things, and build confidence, every day offers something exciting to discover.",
    sentiment: "",
    ageRange: "7-12",
  ...
  // ===================================================
  {
    ...
    tags: ["day-camp", "ages-4-15", "multi-activity", "social-emotional-learning", "Sharon-MA", "ACA-accredited"],
    neighborhood: "sharon",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["Montessori", "summer-camp", "child-development", "hands-on-learning", "student-centered", "Norwood-MA"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["recreation", "summer camp", "community", "all ages", "westwood", "ma"],
    neighborhood: "westwood",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["summer camp", "multi-sport", "STEM", "arts", "Canton MA", "day camp"],
    neighborhood: "canton",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["after-school care", "before-school care", "enrichment", "STEM", "arts"],
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "youth development", "YMCA", "summer camp", "nature exploration", "multi-activity"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "summer camp", "traditional camp", "recreational activities"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["summer enrichment", "academic support", "multi-age", "enrichment", "July program"],
    neighborhood: "foxborough",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "personal safety", "field trips", "arts and crafts", "multi-activity", "youth development"],
    neighborhood: "wrentham",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["community recreation", "youth programs", "athletic fields", "parks", "playgrounds"],
    neighborhood: "norfolk",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["summer camp", "youth programs", "recreation", "field trips", "leadership"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    tags: ["childcare", "daycare", "summer-program", "flexible-schedule", "licensed", "pre-k"],
    neighborhood: "plainville",
  ...
  },
  {
    ...
    tags: ["selective mutism", "social anxiety", "confidence building", "speech therapy", "therapeutic camp", "mental health"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["afterschool", "summer camp", "brookline", "enrichment", "childcare"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "special-needs",
    tags: ["daycare", "preschool", "early-education", "year-round", "NAEYC-accredited", "summer-program"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day-camp", "multi-activity", "arts", "swimming", "ages-preK-10", "ACA-accredited"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "multi-activity", "arts", "sports", "nature", "ages 3-15"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["recreation", "brookline", "vendor programs", "financial aid", "community"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "special-needs",
    tags: ["preschool", "toddler", "play-based", "summer program", "cooperative", "early-childhood"],
    neighborhood: "brookline",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["Jewish camp", "multi-activity", "values-based", "community", "summer program", "Boston"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["bilingual", "German immersion", "international curriculum", "preschool-grade6", "summer program", "language learning"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["ymca", "day camp", "discovery", "nature", "summer camp", "all ages"],
    neighborhood: "franklin",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["summer camp", "full-time", "field trips", "swimming", "arts and crafts"],
    neighborhood: "franklin",
    ...
    registrationDeadline: "Check website",
    documents: ["Check website"],
    weeks: ["w01", "w02", "w04", "w05", "w06", "w07", "w08", "w09", "w10", "w11"]
  },
  {
    id: "milford-community-school-use-program-milford-community-schoo",
    name: "Milford Community School Use Program",
    provider: "Milford Community School Use Program",
    category: "life",
    subcategory: "leadership",
    tags: ["community-program", "year-round", "recreational", "educational", "multi-age"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["youth center", "summer camp", "community program", "ages 8-18", "multi-activity"],
    neighborhood: "norwood",
    ...
    registrationDeadline: "Check website",
    documents: ["Health Care Policy", "Weather Advisory", "Pick Up Policy"],
    weeks: ["w03", "w04", "w05", "w06", "w07", "w08"]
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "preschool", "early childhood", "junior day camp", "ages 3.5-5", "early learners", "summer program"],
    neighborhood: "norwood",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "elementary", "multi-activity", "junior day camp", "ages 3.5-5", "preschool", "early learners", "summer program"],
    neighborhood: "norwood",
    description: "Junior Day Camp serves children ages 3.5-5 years old, offering an engaging summer experience with activities designed for early learners. The camp is part of Summer at Norwood's comprehensive program options for children from preschool through rising 9th grade.",
    sentiment: "",
    ageRange: "6-11",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["middle school", "academies", "enrichment", "junior day camp", "ages 3.5-5", "preschool", "day camp", "early learners"],
    neighborhood: "norwood",
    description: "Junior Day Camp serves children ages 3.5-5 years old, offering an engaging summer experience with activities designed for early learners. The camp is part of Summer at Norwood's comprehensive program options for children from preschool through rising 9th grade.",
    sentiment: "",
    ageRange: "10-13",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["adventure", "middle school", "outdoor", "junior day camp", "ages 3.5-5", "preschool", "day camp", "early learners"],
    neighborhood: "norwood",
    description: "Junior Day Camp serves children ages 3.5-5 years old, offering an engaging summer experience with activities designed for early learners. The camp is part of Summer at Norwood's comprehensive program options for children from preschool through rising 9th grade.",
    sentiment: "",
    ageRange: "10-14",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["wildlife", "forest", "wetlands", "ecosystem", "outdoor exploration", "nature-study", "outdoor-exploration", "hands-on-learning"],
    neighborhood: "norfolk",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "licensed camp", "state vouchers accepted"],
    neighborhood: "weymouth",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "nature", "licensed camp"],
    neighborhood: "weymouth",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "nature", "Weymouth and Braintree residents only"],
    neighborhood: "weymouth",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "police academy", "Weymouth residents only", "rolling registration"],
    neighborhood: "weymouth",
    ...
    documents: ["Camp ID required", "Health Form"],
    weeks: ["w01", "w02", "w03", "w04", "w05", "w06", "w07", "w08", "w09", "w10"]
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["day camp", "YMCA", "youth development", "summer camp", "nature exploration", "multi-activity"],
    neighborhood: "foxborough",
    description: "The Foxboro YMCA offers overnight, day, and specialty camps where kids explore nature, discover new talents, try new activities, and gain independence while making lasting friendships and memories. Programs include Day Camp and School Break Camp options designed for discovery and fun.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["school break camp", "YMCA", "youth development", "day camp", "summer camp", "nature exploration", "multi-activity"],
    neighborhood: "foxborough",
    description: "The Foxboro YMCA offers overnight, day, and specialty camps where kids explore nature, discover new talents, try new activities, and gain independence while making lasting friendships and memories. Programs include Day Camp and School Break Camp options designed for discovery and fun.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["traditional camp", "arts and crafts", "sports", "swimming", "drama", "games", "traditional-camp", "arts-crafts"],
    neighborhood: "dedham",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["leadership", "teen program", "counselor training", "team-building", "life skills", "traditional-camp", "arts-crafts", "sports"],
    neighborhood: "dedham",
    description: "DCH Summer Camp offers children entering Kindergarten through 6th grade the quintessential camp experience with traditional arts and crafts, sports, games, drama, swimming, and more on a gorgeous Dedham campus. Since 1924, the camp has brought together children from the local area for fun, safe, and enriching summer activities. The camp creates core memories, builds lifelong friendships, and helps children develop key life skills.",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["summer camp", "variety", "fun", "multi-activity", "arts", "sports", "STEAM", "adventure"],
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["recreation", "flexible", "day camp", "multi-program", "flexible scheduling", "long-island", "day-camp", "academies"],
    neighborhood: "holbrook",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["water-sports", "beach", "soccer", "basketball", "kayaking", "paddle-boarding", "arts-and-crafts", "inclusive"],
    neighborhood: "weymouth",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["nature exploration", "wildlife", "outdoor learning", "hands-on activities", "sanctuary", "ecology", "nature-camp", "outdoor-learning"],
    neighborhood: "norfolk",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["soccer", "nature", "cooking", "swim", "sports", "arts", "enrichment", "leadership"],
    neighborhood: "foxborough",
    description: "Hockomock Area YMCA offers comprehensive day camps and youth programs featuring swim lessons, sports, recreation, arts and enrichment activities. The camp includes specialty programs, academic enrichment, and leadership development for children of various ages throughout the summer.",
    sentiment: "",
    ageRange: "3-18",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["traditional camp", "sports", "crafts", "archery", "nature", "science", "music", "ropes course"],
    neighborhood: "wellesley",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["specialty programs", "two-week sessions", "interests-based", "day camp", "ages 3+", "traditional camp activities", "swimming lessons", "noncompetitive"],
    neighborhood: "wellesley",
    description: "The Three's Program at Tenacre Summer is designed for three-year-olds and offers a nurturing, noncompetitive camp environment with traditional activities like sports, crafts, archery, nature, science, and music. Every camper receives a swimming lesson every day in a supportive setting that fosters self-esteem and individual accomplishments.",
    sentiment: "I value the professionalism of the staff and the confidence I have that they are taking care of my child and ensuring his safety and opportunity to explore new things (especially swimming).",
    ageRange: "3-6",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["swim lessons", "30-minute lessons", "day camp", "ages 3+", "traditional camp activities", "swimming lessons", "noncompetitive"],
    neighborhood: "wellesley",
    description: "The Three's Program at Tenacre Summer is designed for three-year-olds and offers a nurturing, noncompetitive camp environment with traditional activities like sports, crafts, archery, nature, science, and music. Every camper receives a swimming lesson every day in a supportive setting that fosters self-esteem and individual accomplishments.",
    sentiment: "I value the professionalism of the staff and the confidence I have that they are taking care of my child and ensuring his safety and opportunity to explore new things (especially swimming).",
    ageRange: "3-12",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["soccer", "t-ball", "baseball", "skills building", "confidence building", "day camp", "ages 3+", "traditional camp activities"],
    neighborhood: "wellesley",
    description: "The Three's Program at Tenacre Summer is designed for three-year-olds and offers a nurturing, noncompetitive camp environment with traditional activities like sports, crafts, archery, nature, science, and music. Every camper receives a swimming lesson every day in a supportive setting that fosters self-esteem and individual accomplishments.",
    sentiment: "I value the professionalism of the staff and the confidence I have that they are taking care of my child and ensuring his safety and opportunity to explore new things (especially swimming).",
    ageRange: "3-7",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["general camp", "day camp", "PreK-10th grade", "ACA-accredited", "day-camp", "multi-activity", "arts", "swimming"],
    neighborhood: "brookline",
    description: "Summer at Park offers over 35 general and specialty day camp programs for kids PreK through 10th grade on The Park School's beautiful 34-acre campus and throughout New England. Campers swim, sing, make lifelong friendships, and discover new interests in a safe, fun atmosphere led by professional educators, many of whom are Park teachers. ACA-accredited programs provide opportunities for social engagement, discovery, and joyful summer experiences.",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["sports", "day camp", "ACA-accredited", "day-camp", "multi-activity", "arts", "swimming", "ages-preK-10"],
    neighborhood: "brookline",
    description: "Summer at Park offers over 35 general and specialty day camp programs for kids PreK through 10th grade on The Park School's beautiful 34-acre campus and throughout New England. Campers swim, sing, make lifelong friendships, and discover new interests in a safe, fun atmosphere led by professional educators, many of whom are Park teachers. ACA-accredited programs provide opportunities for social engagement, discovery, and joyful summer experiences.",
    sentiment: "I wanted to first say thank you for a wonderful summer - my 6-year-old absolutely loved the camp. She made new friends, loved swimming outdoors, and brought home amazing projects.",
    ageRange: "3-15",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["science", "technology", "day camp", "ACA-accredited", "day-camp", "multi-activity", "arts", "swimming"],
    neighborhood: "brookline",
    description: "Summer at Park offers over 35 general and specialty day camp programs for kids PreK through 10th grade on The Park School's beautiful 34-acre campus and throughout New England. Campers swim, sing, make lifelong friendships, and discover new interests in a safe, fun atmosphere led by professional educators, many of whom are Park teachers. ACA-accredited programs provide opportunities for social engagement, discovery, and joyful summer experiences.",
    sentiment: "I wanted to first say thank you for a wonderful summer - my 6-year-old absolutely loved the camp. She made new friends, loved swimming outdoors, and brought home amazing projects.",
    ageRange: "3-15",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["arts", "specialty camp", "creative projects", "day-camp", "multi-activity", "swimming", "ages-preK-10", "ACA-accredited"],
    neighborhood: "brookline",
    description: "Summer at Park offers over 35 general and specialty day camp programs for kids PreK through 10th grade on The Park School's beautiful 34-acre campus and throughout New England. Campers swim, sing, make lifelong friendships, and discover new interests in a safe, fun atmosphere led by professional educators, many of whom are Park teachers. ACA-accredited programs provide opportunities for social engagement, discovery, and joyful summer experiences.",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["general camp", "day camp", "swimming", "day-camp", "multi-activity", "arts", "ages-preK-10", "ACA-accredited"],
    neighborhood: "brookline",
    description: "Summer at Park offers over 35 general and specialty day camp programs for kids PreK through 10th grade on The Park School's beautiful 34-acre campus and throughout New England. Campers swim, sing, make lifelong friendships, and discover new interests in a safe, fun atmosphere led by professional educators, many of whom are Park teachers. ACA-accredited programs provide opportunities for social engagement, discovery, and joyful summer experiences.",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["CIT", "counselor training", "leadership development", "day-camp", "multi-activity", "arts", "swimming", "ages-preK-10"],
    neighborhood: "brookline",
    description: "Summer at Park offers over 35 general and specialty day camp programs for kids PreK through 10th grade on The Park School's beautiful 34-acre campus and throughout New England. Campers swim, sing, make lifelong friendships, and discover new interests in a safe, fun atmosphere led by professional educators, many of whom are Park teachers. ACA-accredited programs provide opportunities for social engagement, discovery, and joyful summer experiences.",
    sentiment: "I wanted to first say thank you for a wonderful summer - my 6-year-old absolutely loved the camp. She made new friends, loved swimming outdoors, and brought home amazing projects.",
    ageRange: "13-18",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["general camp", "young children", "activities", "preschool", "day-camp", "ages-4-5", "swimming", "arts-crafts"],
    neighborhood: "dedham",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["general camp", "multi-activity", "co-ed", "preschool", "day-camp", "ages-4-5", "swimming", "arts-crafts"],
    neighborhood: "dedham",
    description: "Camp Thayer's Lower Camp features activities scaled to size for young children ages 3.9 to 5, with a staff-to-child ratio of 1:5. Kids enjoy a set schedule of activities and remain with their groups and counselors throughout the day, participating in swimming, arts & crafts, and age-appropriate recreational activities from 9 a.m. to 2 p.m.",
    sentiment: "",
    ageRange: "6-13",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["leadership", "counselor training", "apprenticeship", "preschool", "day-camp", "ages-4-5", "swimming", "arts-crafts"],
    neighborhood: "dedham",
    description: "Camp Thayer's Lower Camp features activities scaled to size for young children ages 3.9 to 5, with a staff-to-child ratio of 1:5. Kids enjoy a set schedule of activities and remain with their groups and counselors throughout the day, participating in swimming, arts & crafts, and age-appropriate recreational activities from 9 a.m. to 2 p.m.",
    sentiment: "",
    ageRange: "14-15",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["basketball", "skills", "non-competitive", "lunch included", "free swim", "preschool", "day-camp", "ages-4-5"],
    neighborhood: "dedham",
    description: "Camp Thayer's Lower Camp features activities scaled to size for young children ages 3.9 to 5, with a staff-to-child ratio of 1:5. Kids enjoy a set schedule of activities and remain with their groups and counselors throughout the day, participating in swimming, arts & crafts, and age-appropriate recreational activities from 9 a.m. to 2 p.m.",
    sentiment: "",
    ageRange: "8-13",
  ...
  },
  {
    ...
    category: "life",
    subcategory: "leadership",
    tags: ["theater", "musical", "singing", "dancing", "acting", "lunch included", "free swim", "preschool"],
    neighborhood: "dedham",
    description: "Camp Thayer's Lower Camp features activities scaled to size for young children ages 3.9 to 5, with a staff-to-child ratio of 1:5. Kids enjoy a set schedule of activities and remain with their groups and counselors throughout the day, participating in swimming, arts & crafts, and age-appropriate recreational activities from 9 a.m. to 2 p.m.",
    sentiment: "",
    ageRange: "6-9",
